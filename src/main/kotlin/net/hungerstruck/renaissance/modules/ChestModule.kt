...
class ChestModule(match: RMatch, modCtx: RModuleContext) : RModule(match, modCtx) {
    ...
    private fun setupItems() {
        ...
        initialItems.add(0.1, ItemStack(Material.WOOD_SWORD, 1))
        initialItems.add(0.3, ItemStack(Material.WOOD_SPADE, 1))
        initialItems.add(0.15, ItemStack(Material.LOG, 2))
        initialItems.add(0.2, ItemStack(Material.ARROW, 4))
        initialItems.add(0.25, ItemStack(Material.ARROW, 3))
        initialItems.add(0.4, ItemStack(Material.BOW, 1))
        ...
        initialItems.add(0.15, ItemStack(Material.CHAINMAIL_HELMET, 1))
        initialItems.add(0.13, ItemStack(Material.CHAINMAIL_CHESTPLATE, 1))
        initialItems.add(0.13, ItemStack(Material.CHAINMAIL_LEGGINGS, 1))
        initialItems.add(0.15, ItemStack(Material.CHAINMAIL_BOOTS, 1))
        initialItems.add(0.39, ItemStack(Material.APPLE, 3))
        initialItems.add(0.39, ItemStack(Material.BREAD, 2))
        ...
        initialItems.add(0.23, ItemStack(Material.ENDER_PEARL, 1))
        ...
        initialItems.add(0.18, ItemStack(Material.STONE_AXE, 1))
        ...
        feastItems.add(0.06, ItemStack(Material.IRON_SWORD, 1))
        ...
        feastItems.add(0.08 * rareMultiplier, ItemStack(Material.IRON_HELMET, 1))
        feastItems.add(0.06 * rareMultiplier, ItemStack(Material.IRON_CHESTPLATE, 1))
        feastItems.add(0.06 * rareMultiplier, ItemStack(Material.IRON_LEGGINGS, 1))
        feastItems.add(0.08 * rareMultiplier, ItemStack(Material.IRON_BOOTS, 1))
        ...
        feastItems.add(0.22 * rareMultiplier, ItemStack(Material.COOKED_CHICKEN, 3))
        feastItems.add(0.22 * rareMultiplier, ItemStack(Material.COOKED_BEEF, 3))
        feastItems.add(0.22 * rareMultiplier, ItemStack(Material.COOKED_FISH, 3))
